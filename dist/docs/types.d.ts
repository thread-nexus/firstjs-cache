 ...
 * @enum {string}
 */
export declare enum CacheOperationStatus {
 ...
 */
export declare const enum DocCategory {
    CORE = "Core",
    UTILS = "Utilities",
    HOOKS = "React Hooks",
    EVENTS = "Events",
 ...
 */
export declare const enum DocPriority {
    CRITICAL = 1,
    HIGH = 2,
    MEDIUM = 3,
    LOW = 4
 ...
 */
export declare const enum ResourceImpact {
 ...
 */
export declare const enum PerformanceImpact {
