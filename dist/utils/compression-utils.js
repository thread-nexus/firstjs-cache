...
exports.DEFAULT_COMPRESSION_OPTIONS = void 0;
 ...
 */
exports.DEFAULT_COMPRESSION_OPTIONS = {
    enabled: true,
    algorithm: 'gzip',
    level: 6,
    threshold: 1024 // 1KB
...
async function compressIfNeeded(data, options = {}) {
    const opts = { ...exports.DEFAULT_COMPRESSION_OPTIONS, ...options };
    // Ensure threshold is defined
    const threshold = opts.threshold || exports.DEFAULT_COMPRESSION_OPTIONS.threshold;
    if (!opts.enabled) {
        return {
 ...
 * @returns Decompressed data
 */
async function decompressIfNeeded(data, algorithm) {
    if (!algorithm) {
        return data;
    }
    try {
...
async function compressData(data, algorithm = 'gzip') {
    ...
    const threshold = exports.DEFAULT_COMPRESSION_OPTIONS.threshold;
    if (buffer.length < threshold) {
        return {
            data: buffer,
            originalSize: buffer.length,
 ...
 * @returns Decompressed data
 */
async function decompressData(data, algorithm = 'gzip') {
