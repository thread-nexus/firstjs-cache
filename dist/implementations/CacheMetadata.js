...
class CacheMetadata {
    ...
    create(key, tags = [], options = {}) {
        ...
        (0, cache_events_1.emitCacheEvent)(cache_events_1.CacheEventType.METADATA_UPDATE, {
            key,
            metadata: entry,
            type: cache_events_1.CacheEventType.METADATA_UPDATE.toString(),
            timestamp: Date.now()
        });
        return entry;
    }
    ...
    delete(key) {
        ...
        if (deleted) {
            ...
            (0, cache_events_1.emitCacheEvent)(cache_events_1.CacheEventType.METADATA_DELETE, {
                key,
                type: cache_events_1.CacheEventType.METADATA_DELETE.toString(),
                timestamp: Date.now()
            });
        }
        return deleted;
    ...
    clear() {
        ...
        (0, cache_events_1.emitCacheEvent)(cache_events_1.CacheEventType.METADATA_CLEAR, {
            count,
            type: cache_events_1.CacheEventType.METADATA_CLEAR.toString(),
            timestamp: Date.now()
        });
    }
    /**
