...
const cacheEvents_1 = require("../events/cacheEvents");
const CacheManagerAdvanced_1 = require("./CacheManagerAdvanced");
/**
 * Extension of CacheManager with statistics functionality
 */
class CacheManagerStats extends CacheManagerAdvanced_1.CacheManagerAdvanced {
    /**
    ...
    getStats() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                (0, cacheEvents_1.emitCacheEvent)('stats', { stats });
                return stats;
            }
            catch (error) {
