...
export function deserialize(value: string): any {
  try {
    ...
    if (value.startsWith('__typedarray__:')) {
      ...
      switch (typeName) {
        case 'Int8Array': return new Int8Array(arrayBuffer);
        case 'Uint8Array': return new Uint8Array(arrayBuffer);
        case 'Uint8ClampedArray': return new Uint8ClampedArray(arrayBuffer);
        case 'Int16Array': return new Int16Array(arrayBuffer);
        case 'Uint16Array': return new Uint16Array(arrayBuffer);
        case 'Int32Array': return new Int32Array(arrayBuffer);
        case 'Uint32Array': return new Uint32Array(arrayBuffer);
        case 'Float32Array': return new Float32Array(arrayBuffer);
        case 'Float64Array': return new Float64Array(arrayBuffer);
        case 'BigInt64Array': return new BigInt64Array(arrayBuffer);
        case 'BigUint64Array': return new BigUint64Array(arrayBuffer);
        default: return new Uint8Array(arrayBuffer);
      }
    }
